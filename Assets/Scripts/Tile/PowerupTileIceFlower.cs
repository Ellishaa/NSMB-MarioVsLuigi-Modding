...
[CreateAssetMenu(fileName = "PowerupTileIceFlower", menuName = "ScriptableObjects/Tiles/PowerupTileIceFlower", order = 2)]
public class PowerupTileIceFlower : BreakableBrickTile {
